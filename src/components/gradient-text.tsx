...
export default function GradientText({
  ...
  const gradientAngle =
    direction === "horizontal"
      ...
      : direction === "vertical"
        ? "to bottom"
        : "to bottom right"
  const gradientColors = [...colors, colors[0] ?? "#5227FF"].join(", ")
  ...
  return (
    <motion.div
      className={cn(
        "relative inline-flex max-w-fit flex-row items-baseline justify-center overflow-hidden font-medium transition-shadow duration-500",
